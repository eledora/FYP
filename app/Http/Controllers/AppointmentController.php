...
class AppointmentController extends Controller
{
    ...
    public function check (Request $request){
        ...
        if(!$appointment){
            return redirect()->to('/appointment')->with('errmessage','Working hours not available for this date.');
        }
    ...
    public function updateTime (Request $request){
        ...
        return redirect()->route('appointment.index')->with('message','Working hours updated');
    }
