                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <span class="text">UniK Appointment</span>
                        </a>
                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Counselors</span> <span class="badge badge-danger"></span></a>
                                    <div class="submenu-content">
                                        <a href="{{ route('counselor.index') }}" class="menu-item">View</a>
                                        <a href="{{ route('counselor.create') }}"  class="menu-item">Create</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
